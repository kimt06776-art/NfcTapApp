...
사용자 메시지를 다음 6가지 카테고리 중 하나로 분류하세요:
...
3. **bible_study** - 성경 공부, 해석, 의미 질문
   - "요한복음 3:16이 무슨 뜻이야?"
   - "바울이 말한 사랑의 의미가 뭐야?"
   - "이 구절의 역사적 배경이 궁금해"
   - "성경에서 ~ 에 대해 알려줘"

4. **counseling** - 위로, 상담, 고민 상담
   - "요즘 힘들어..."
   - "불안하고 걱정돼"
   - "어떻게 해야 할지 모르겠어"
   - 감정 표현, 고민 토로

5. **prayer** - 기도 요청, 기도문 작성
   - "기도해줘"
   - "함께 기도하자"
   - "기도문 작성해줘"
   - "~를 위해 기도해줘"

6. **general** - 일반 대화, 인사, 기타
   - "안녕"
   - "뭐해?"
...
- "설교 노트", "설교 필기", "설교 기록", "설교 메모" 관련 요청은 sermon_note
